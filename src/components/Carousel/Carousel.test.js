...
const slides = [
  {
    imgLink: 'https;//exmaple.com/slide1.png',
    description: 'Slide1',
    attribution: 'Bob1'
  },
  {
    imgLink: 'https;//exmaple.com/slide2.png',
    description: 'Slide2',
    attribution: 'Bob2'
  },
  {
    imgLink: 'https;//exmaple.com/slide3.png',
    description: 'Slide3',
    attribution: 'Bob3'
  }
];
...
describe('Carousel', () => {
  ...
  it('renders a Carousel', () => {
    ...
    expect(img.getAttribute('src')).toBe(slides[0].imgLink);
    ...
    expect(img.getAttribute('src')).toBe(slides[1].imgLink);
    expect(figure).toHaveTextContent(
    ...
    expect(img.getAttribute('src')).toBe(slides[2].imgLink);
    expect(figure).toHaveTextContent(
